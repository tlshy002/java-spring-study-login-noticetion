...
<form:form action="../entry/register.html" method="post" name="frm" 
	modelAttribute="user" onsubmit="return check()">
<form:hidden path="idChecked" /><font color="red"><form:errors path="idChecked"/></font>
<table>
	...
	<tr><th>암 호</th><td><form:input path="user_pw"/> 
...
function check() {
	if(document.frm.user_pw.value != document.frm.CONFIRM.value) {
