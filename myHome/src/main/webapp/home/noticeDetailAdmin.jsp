...
<table>
	<tr><th>공지글 번호</th><td><input type="text" value="${NOTICE.num }" /></td></tr>
	<tr><th>공지글 제목</th><td><input type="text" name="TITLE" value="${NOTICE.title }"/></td></tr>
	...
	<tr><td colspan="2" align="center"><input type="submit" value="수 정"/>
		<input type="submit" value="삭 제"/></td>
</table>
</form>
</div>
